...
imwrite(imread('Splash.tiff'),'Ori_photo.jpg','jpeg','quality',80);     %生成质量因子为XX的JPEG图像
...
%得到交换表
[exchange_table]=Getexchange_table(ori_blockdct);    
...
capacity=TypeA*log2(3)+TypeB+TypeC-56;
